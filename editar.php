        ...
        <div class="col-lg-12">
            ...
            <form method="post" action="<?php editar(); ?>" class="jumbotron" style="margin-top: 15px">
                <div class="form-group">
                    ...
                    <input required class="form-control" type='text' placeholder="Romulo Sousa Sá" id="nome" name="nome"
                           value="<?= $pessoa['nome'] ?>">
                </div>
                <div class="form-group">
                    <label for="nascimento">Data de nascimento</label>
                    <input required type='date' id="nascimento" class="form-control" name="data_nascimento"
