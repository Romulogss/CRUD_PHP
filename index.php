                ...
                <div class="modal-footer">
                    <? if (isset($_GET['id'])) : ?>
                        <form action="<?php excluir(); ?>" method="get">
                            ...
                            <a class="btn btn-primary" id="confirm" href="#">Sim</a>
                        </form>
                    <?php else : ?>
                        <button type="submit" class="btn btn-secondary" data-dismiss="modal">Não</button>
                        <a class="btn btn-primary" id="confirm" href="#">Sim</a>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                ...
                <form method="post" action="<?php adicionar(); ?>" class="jumbotron" style="margin-top: 15px">
                    <div class="form-group">
                        ...
                        <input required class="form-control" type='text' placeholder="Seu nome completo" id="nome" name="nome" value="<?php if (!empty($pessoa['nome'])) echo $pessoa['nome'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="nascimento">Data de nascimento</label>
                        <div class="form-inline">
                            <input style="width: 60%;" required onblur="calcularIdade()" type='date' id="nascimento" class="form-control" name="data_nascimento" value="<?php if (!empty($pessoa['data_nascimento'])) echo $pessoa['data_nascimento'] ?>">
                    ...
                    <label>Sexualidade</label> <br>
                    <div class="form-check form-check-inline">
                        <input required id="masculino" class="form-check-input" type="radio" value="<?php if (!empty($pessoa['sexo'])) echo $pessoa['sexo'];
                                                                                                    else echo "m" ?>" name="sexo">
                        <label for="masculino" class="form-check-label">Masculino</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input required id="feminino" class="form-check-input" type="radio" value="<?php if (!empty($pessoa['sexo'])) echo $pessoa['sexo'];
                                                                                                    else echo "f" ?>" name="sexo">
                        <label for="feminino" class="form-check-label">Feminino</label>
                    </div>
                    <div class="form-group form-check" style="margin-top: 15px;">
                        <input class="form-check-input" value="<?php if (!empty($pessoa['tem_filhos'])) echo $pessoa['tem_filhos'];
                                                                else echo "s" ?>" type="checkbox" id="filhos" name="tem_filhos">
                        ...
                        <?php if ($pessoas) : ?>
                            ...
                            <?php foreach ($pessoas as $pessoa) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo calculo_idade($pessoa['data_nascimento']) ?> anos</td>
                                    <td><?php echo $pessoa['escolaridade'] ?></td>
                                    <td><?php if ($pessoa['sexo'] === 'm') echo "Masculino";
                                                else echo "Feminino"; ?></td>
                                    <td><?php if ($pessoa['tem_filhos']) echo 'Sim';
                                                else echo 'Não'; ?></td>
                                    <td>
                                        <form action="<?php editar(); ?>" method="get">
                                            ...
                                            <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-excluir" data-pessoa="<?php echo $pessoa['id']; ?>" data-nome="<?php echo $pessoa['nome'] ?>">
